## 🚀  **Ngắm Gái Xinh ở daohuyenmy-v2 : không cache video** ! 🚀


**- Trang được code dựa theo cấu trúc nhỏ giống Tiktok, dùng để xem các video đã được upload lên server**
</br>
**- Mã nguồn cũng như logic tương tư phiên bản chính, khác ở chỗ -v2 không cache video vào Service Worker**

<br/>

## 👉 Xem ngay [Ở ĐÂY](https://tongtrankien1605.github.io/daohuyenmy-v2) ạ !
...
## 💻 Giải thích các BASE_URL:
    ...
    ( ví dụ xây dựng trên github có repository là daohuyenmy-v2 => thì REPOSITORY_ROOT = "/daohuyenmy-v2/" )
              
    const VIDEOS_JSON_URL: Đường dẫn đến file JSON chứa thông tin video như Title, URL, Desription, dayCreate
    ( ví dụ xây dựng trên github có repository là daohuyenmy-v2 => thì const VIDEOS_JSON_URL = `${REPOSITORY_ROOT}videos.json`;
